# staging — mirrors production config for pre-release verification (docs/08-INFRA-DEPLOYMENT.md §1).
# Structurally identical to prod (same modules), differing only in intentional, reviewable
# sizing per docs/09-TERRAFORM-IAC.md §2 — not architecture.
